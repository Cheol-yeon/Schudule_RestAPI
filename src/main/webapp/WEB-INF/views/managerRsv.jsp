...
<body>
	...
	<div style="text-align: center;">
		<input type="button" class="button" id="category1" value="studiorsv" name="btn1" /> 
		<input type="button" class="button" id="category2" value="rentalrsv" name="btn2" /> 
		<input type="button" class="button" id="category3" value="btn3rsv" name="btn3" /> 
		<input type="button" class="button" id="category4" value="btn4rsv" name="btn4" />
